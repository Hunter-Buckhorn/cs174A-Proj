...
SQLMarket_Accounts = 'INSERT INTO Market_Accounts (aid,balance,taxid,day_of_the_month, running_balance_sum, initial_balance) VALUES ("{}",{},"{}",{}, {}, {});'

with open("Market.txt", "r") as market:
    for line in market:
        taxid,aid, balance = line.strip().split(",")
        print(SQLMarket_Accounts.format(aid, balance, taxid, 15, 15 * float(balance), balance))
