...
public class TriggerTests {
   public static void main(String[] args) {
       ...
       AccrueTriggerTest();
       EarningAfterSellTest();
       AfterPurchaseTest_IncTotCommission();
    }
    ...
    private static void AfterPurchaseTest_IncTotCommission() {
        String test_name = new Object(){}.getClass().getEnclosingMethod().getName();
        DBInteraction.setupTestDB();
        float actual = 0.0f;
        float amt = 1.243f;
    ...
    private static void EarningAfterSellTest() {
        String test_name = new Object(){}.getClass().getEnclosingMethod().getName();
        DBInteraction.setupTestDB();
        float amt = 1.125f;
        try {
            ...
            float expected = (STOCK_PRICE_STUB - STOCK_BUYING_PRICE_STUB) * amt;
            if (isEqual(expected, actual)) pass(test_name);
            else fail(test_name, "");
        }
        catch (SQLException e) {
